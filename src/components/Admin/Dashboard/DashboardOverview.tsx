    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        ...
        <StatsCard
          ...
          icon={<MessageSquare className="w-4 h-4 text-[#60A5FA]" />}
        ...
        <StatsCard
          ...
          icon={<BookOpen className="w-4 h-4 text-[#60A5FA]" />}
        ...
        <StatsCard
          ...
          growth={1.2}
          icon={<ShieldCheck className="w-4 h-4 text-[#60A5FA]" />}
        ...
        <StatsCard
          ...
          value="1,240"
          growth={5.4}
          icon={<Cpu className="w-4 h-4 text-[#60A5FA]" />}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="p-5 rounded-2xl bg-[#111827] border border-white/10 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-2.5">
            <button
              ...
              className="w-full py-2.5 px-4 rounded-xl bg-[#2563EB] hover:bg-[#1d4ed8] text-white font-bold text-xs transition-all shadow-[0_0_15px_rgba(37,99,235,0.3)] flex items-center justify-between group cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full py-2.5 px-4 rounded-xl bg-white/5 hover:bg-[#102A56] text-gray-200 hover:text-[#60A5FA] border border-white/10 hover:border-[#2563EB]/40 font-semibold text-xs transition-all flex items-center justify-between group cursor-pointer"
            >
              <span className="flex items-center gap-2">
            ...
            >
              <span className="flex items-center gap-2">
                <FileCheck2 className="w-4 h-4 text-[#60A5FA]" />
        ...
        <div className="p-5 rounded-2xl bg-[#111827] border border-white/10 space-y-4 lg:col-span-2">
          <div className="flex items-center justify-between pb-3 border-b border-white/10">
            ...
            <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold bg-[#2563EB]/20 text-[#60A5FA] border border-[#2563EB]/40 flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-3.5 rounded-xl bg-black/40 border border-white/5 space-y-1">
              ...
              <p className="text-xl font-bold text-[#60A5FA]">99.98%</p>
            ...
            <div className="p-3.5 rounded-xl bg-black/40 border border-white/5 space-y-1">
              ...
              <p className="text-[10px] text-[#60A5FA] font-mono">-15ms vs last week</p>
            </div>
          ...
          <div className="p-3 rounded-xl bg-[#102A56]/40 border border-[#2563EB]/30 text-xs text-gray-300 flex items-center justify-between">
            <span className="flex items-center gap-2">
            ...
            <button
              ...
              className="text-[#60A5FA] hover:underline font-bold text-[11px]"
            >
              Configure Policy →
            </button>
          </div>
      ...
      <div className="p-5 rounded-2xl bg-[#111827] border border-white/10 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-white/10">
          ...
          <button
            ...
            className="text-xs font-bold text-[#60A5FA] hover:underline flex items-center gap-1"
          >
